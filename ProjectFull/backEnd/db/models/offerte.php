...
class Offerte extends DataBaseCore{
    ...
    function addOfferta($aziendaId, $titolo, $descrizione, $requisiti, $sedeId, $retribuzione, $tipoContrattoId, $dataScadenza) {
        ...
        $stmt = $this->conn->prepare(
            "INSERT INTO offerte (azienda_id, titolo, descrizione, data_pubblicazione, retribuzione, sede_lavoro_id, tipo_contratto_id, data_scadenza)
             VALUES (?, ?, ?, NOW(), ?, ?, ?, ?)"
        );
        ...
        $stmt->bind_param("isssiis", $aziendaId, $titolo, $descrizione, $retribuzione, $sedeId, $tipoContrattoId, $dataScadenza);
