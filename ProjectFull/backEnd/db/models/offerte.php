...
class Offerte extends DataBaseCore{
    ...
    function addOfferta($aziendaId, $titolo, $descrizione, $requisiti, $sedeId, $categoriaId) {
        ...
        $stmt = $this->conn->prepare(
            "INSERT INTO offerte (azienda_id, titolo, descrizione, data_pubblicazione, sede_id, categoria_id)
             VALUES (?, ?, ?, NOW(), ?, ?)"
        );
        ...
        $stmt->bind_param("issii", $aziendaId, $titolo, $descrizione, $sedeId, $categoriaId);
